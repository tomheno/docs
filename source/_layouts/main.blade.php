...
@section('body')
    <header class="bg-white text-gray-700">
        ...
        <nav class="px-6 py-12 lg:py-24">
            <ol class="max-w-screen-2xl mx-auto relative flex justify-between md:text-lg">
                <li class="absolute left-1/2 top-1/2 transform -translate-x-1/2 -translate-y-1/2">
                    <a href="/" rel="home" class="transition-colors duration-200 hover:text-blue-700">
                        <x-logo :alt="$page->siteName" class="w-36 h-auto" />
                    </a>
                </li>
                <li><a href="#" class="hover:text-blue-700 hover:underline transition-colors duration-200">Documentation</a></li>
                <li>
                    <a 
